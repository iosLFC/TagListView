...
open class TagListView: UIView {
    ...
    private func createNewTagView(_ title: String, _ showLeftImage: Bool = false, _ leftImage: UIImage = UIImage()) -> TagView {
        let tagView = TagView(title: title, showLeftImage: showLeftImage, leftImage: leftImage)
    ...
    @discardableResult
    open func addTag(_ title: String, _ showLeftImage: Bool = false, _ leftImage: UIImage = UIImage()) -> TagView {
        defer { rearrangeViews() }
        return addTagView(createNewTagView(title, showLeftImage, leftImage))
    }
